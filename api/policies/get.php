<?php
/**
 * VALERIE JEWELS — Public Legal Policies Endpoint
 * Returns dynamic configuration for Shipping, Return & Refund, Privacy Policy (DPDP 2023), and Terms of Service.
 */
...
try {
    ...
    if ($raw) {
        ...
        if (is_array($data) && !empty($data)) {
            ApiResponse::success($data, 'Legal policies retrieved successfully.');
            exit;
        }
    }

    // Default policy data structure matching Indian D2C benchmark
    $defaults = [
        'meta' => [
        ...
        'shipping' => [
            ...
            'sections' => [
                ...
                [
                    ...
                    'content' => 'Our standard estimated delivery time is 5 to 7 working days from the date of dispatch across all major cities, metro regions, and tier-2/tier-3 pin codes across India. In remote regions or Northeast territories, delivery may occasionally take an additional 1–2 business days depending on local courier logistics.'
                ],
                [
                    'id' => 'free-shipping',
                    'heading' => '3. Free Delivery Across All India (₹0 Shipping Fee)',
                    'content' => 'We proudly offer 100% Free Express Delivery across India on all jewelry collections and combo boxes, with zero hidden freight charges at checkout regardless of destination pincode.'
                ],
                [
                    'id' => 'prepaid-perks',
        ...
        'refund' => [
            ...
            'sections' => [
                [
                    ...
                    'content' => 'We want you to adore every piece you wear. We provide a 5 to 7 day return and exchange window starting from the verified delivery timestamp provided by the courier partner for any items that arrive damaged, defective, or incorrect.'
                ],
                [
        ...
        'terms' => [
            ...
            'sections' => [
                ...
                [
                    ...
                    'content' => 'VALERIÉ shall not be liable for any indirect, incidental, special, or consequential damages resulting from the use or inability to use the products. In all cases, our maximum aggregate liability shall be strictly limited to the amount paid by the customer for the specific jewelry piece in dispute.'
                ],
                [
